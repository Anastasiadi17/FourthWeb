   ...
   <div id="form">
	...
	<form action="" method="POST">
	  ...
	  <label <?php if(!empty($errors['super'])) print 'class="error_check"'?>><b>Сверхспособности:</b></label><br />
          <input type="checkbox" id="bessmertie" name="super[] value="bessmertie" <?php if(isset($values['super']['bessmertie'])&&$values['super']['bessmertie']=='bessmertie')print("checked");?>><span>Бессмертие</span>
          <input type="checkbox" id ="steny" name="super[] value="steny" selected="selected" <?php if(isset($values['super']['steny'])&&$values['super']['steny']=='steny')print("checked");?>><span>Прохождение скозь стены</span>
		  <input type="checkbox" id ="levitation" name="super[] value="levitation" <?php if(isset($values['super']['levitation'])&&$values['super']['levitation']=='levitation')print("checked");?>><span>Левитация</span>
          <input type="checkbox" id ="mysli" name="super[] value="mysli" <?php if(isset($values['super']['mysli'])&&$values['super']['mysli']=='mysli')print("checked");?>><span>Чтение мыслей</span>
      <br />
